...
def run_linear(
    ...
    # Create Linear module with the specified dimensions
    linear = nn.Linear(in_features=d_in, out_features=d_out)
...
def run_rmsnorm(
    ...
    """
    rms_norm = nn.RMSNorm(d_model, eps)
